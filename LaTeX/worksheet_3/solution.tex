...
\end{center}
In case of Sparsegrid using Clenshaw-Curtis it makes no difference between using Random-walk- or Brownian-Bridge-construction.
\section*{Task 16}
\begin{center}
...
\end{center}
Again, Brownian Bridge does not have any feasible effect,only by MC and QMC one can find some negligible differences. 
\section*{Task 17}
\begin{center}
\includegraphics[scale=0.51]{task17.png}
\end{center}
This again illustrates that use of Brownian-Bridge Interpolation does not bring strong benefits over
Random Walk, especially in case of QMC. Furthermore, the simpler MC method has almost the same convergence as QMC.
